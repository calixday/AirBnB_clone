...
class TestBaseModel(unittest.TestCase):
    ...
    """Test _Cases for the BaseModel class."""
    ...
    def test_3_instantiation(self):
        """To tests  the instantiation of BaseModel class."""
    ...
    def test_4_instantiation(self):
        ...
        _my_model = BaseModel()
        _my_model.name = "Holberton"
        _my_model.my_number = 89
        _my_model_json = _my_model.to_dict()
        _my_new_model = BaseModel(**_my_model_json)
        self.assertEqual(_my_new_model.to_dict(), _my_model.to_dict())
